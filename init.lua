...
function activate_if_tnt(nname, np, tnt_np, tntr)
    if nname == "nuke:iron_tnt" or nname == "nuke:mese_tnt" or nname == "nuke:hardcore_iron_tnt" or nname == "nuke:hardcore_mese_tnt" then
...
function do_tnt_physics(tnt_np,tntr)
    ...
    for k, obj in pairs(objs) do
        ...
        local p = obj:getpos()
        if oname == "nuke:iron_tnt" or oname == "nuke:mese_tnt" or oname == "nuke:hardcore_iron_tnt" or oname == "nuke:hardcore_mese_tnt" then
...
minetest.register_craft({
	...
	recipe = {
		{'','default:wood 1',''},
		{'default:steel_ingot 1','default:coal_lump 1','default:steel_ingot 1'},
		{'','default:wood 1',''}
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'','default:wood 1',''},
		{'default:mese_crystal 1','default:coal_lump 1','default:mese_crystal 1'},
		{'','default:wood 1',''}
	}
})
...
minetest.register_craft({
	output = 'nuke:hardcore_iron_tnt 1',
	recipe = {
		{'','default:coal_lump 1',''},
		{'default:coal_lump 1','nuke:iron_tnt 1','default:coal_lump 1'},
		{'','default:coal_lump 1',''}
	}
})
...
minetest.register_craft({
	output = 'nuke:hardcore_mese_tnt 1',
	recipe = {
		{'','default:coal_lump 1',''},
		{'default:coal_lump 1','nuke:mese_tnt 1','default:coal_lump 1'},
		{'','default:coal_lump 1',''}
	}
})
